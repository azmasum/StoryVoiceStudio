...
# Fallback for environments launched with the bare system interpreter:
# only use the .pylibs bundle when the current interpreter cannot see the
# dependencies itself (e.g. a real venv already provides them).
